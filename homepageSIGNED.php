...
<body>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#"><img class="logo" src="Pics/logo2.png" alt="logo"></a>
  ...
  <div class="welcome-message col-md-12">
    ...
    <a href="productpageSIGNED.php">Buy Now</a>
  </div>
  ...
  <div class="container initialitem">
    ...
    ?>
    <a class="showmore" href="productpageSIGNED.php">
      <p>Show More</p>
    </a>
